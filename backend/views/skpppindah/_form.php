...
<div class="skpppindah-form">
    ...
    ?>
    <label class="col-form-label">Pegawai yang pindah</label>
    ...
    <?= $form->field($model, 'pindah_sebagai')->textInput(['maxlength' => true]) ?>

    <label class="col-form-label">Jabatan</label>
    <?= $form->field($model, 'id_jabatan')->dropDownList(yii\helpers\ArrayHelper::map(\backend\models\Jabatan::find()->all(), 'id', 'namajabatan'))->label(false) ?>

    <label class="col-form-label">Satuan Kerja</label>
    <?= $form->field($model, 'id_satuankerja')->dropDownList(yii\helpers\ArrayHelper::map(\backend\models\Satuankerja::find()->all(), 'id', 'namasatuankerja'))->label(false) ?>

    <!-- <?php
    $a = ['Januari' => 'Januari', 'Februari' => 'Februari'];
    echo $form->field($model, 'tanggal_surat')->dropDownList($a, ['prompt' => 'Pilih Bulan']);
    ?> -->

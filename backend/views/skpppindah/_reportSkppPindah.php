        ...
        <tbody>
            <tr>
                <td style="text-align: justify;" colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bersama ini kami sampaikan lampiran Surat Keterangan
                    Penghentian Pembayaran (SKPP) Pindah beserta Surat Keputusan (SK) Pemindahan Pegawai Negeri Sipil A.n
                    <strong><?= $model->pegawai->namapegawai ?></strong> NIP <?= $model->pegawai->nip ?> Pangkat / Golongan <?php //= $model->pegawai->golaktif->golongan->pangkat . ' / ' . $model->pegawai->golaktif->golongan->kode_gol; ?> Jabatan <?php //= $model->pegawai->jabatanaktif->jabatan->namajabatan; ?>
                </td>
            </tr>
            <tr>
                <td colspan="4">&nbsp;</td>

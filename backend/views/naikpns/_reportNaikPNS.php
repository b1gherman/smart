...
<div style="padding-left: 95px;padding-right: 75px">
    <table style="width: 100%" border="0">
        <tbody>
            ...
            <tr>
                <td>Perihal</td>
                <td>:Usulan Pengangkatan Menjadi PNS </td>
                <td><br>
                </td>
            </tr>
            <tr>
        ...
        <tbody>
            <tr>
                <td rowspan="1" colspan="4"> Bersama ini kami sampaikan berkas usulan
                    untuk pengangkatan menjadi <b>Pegawai Negeri Sipil</b> atas nama:</td>
            </tr>
            <tr>
    ...
    <table border="0">
        <tbody>
            ...
            <tr>
                <td>1. Kepala Biro Umum BMKG di Jakarta</td>
            </tr>
            <tr>
                <td>2. Kepala Balai Besar MKG Wilayah I di Medan</td>
            </tr>
        </tbody>
    </table>

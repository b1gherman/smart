...
/* @var $searchModel backend\models\SkeluarSuratdinasSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Data Surat Dinas';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="skeluar-suratdinas-index">

    <!-- <h1><?= Html::encode($this->title) ?></h1> -->

    <p>
        <?= Html::a('Create Surat Dinas', ['create'], ['class' => 'btn btn-success']) ?>
    </p>

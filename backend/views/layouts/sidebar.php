<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
        ...
        <span class="brand-text font-weight-light"><i class="fas fa-align-center"> SMART</i></span><br>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                ...
                <a href="#" class="d-block"><?php //echo \Yii::$app->inventori->getUsername(\Yii::$app->user->id); ?></a> -->

...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <?php //$jum_note = Yii::$app->inventori->getJumlahTerlambat(); ?>
        <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#">
                <i class="far fa-bell"></i>
                <span class="badge badge-warning navbar-badge"><?php // $jum_note; ?></span>
            </a>
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <span class="dropdown-header">Notifications</span>
                <div class="dropdown-divider"></div>
                <a href="<?php // \yii\helpers\Url::to(['/peminjaman/terlambat']) ?>" class="dropdown-item">
                    <i class="fas fa-envelope mr-2"></i> Peminjaman lebih dari
                    <span class="float-right text-muted text-sm">10 Hari</span>
                </a>

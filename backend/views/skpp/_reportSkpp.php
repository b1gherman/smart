    ...
    <table style="border-collapse: collapse; width: 100%; height: 100%;" border="1">
        <tbody>
            ...
            <tr style="height: 18px;">
                ...
                <td style="width: 2.00401%; height: 18px;">:</td>
                <td style="width: 71.6109%; height: 18px;" colspan="2"><?= Yii::$app->formatter->asDate($model->tmtberhenti, 'dd-MM-yyyy') ?></td>
            </tr>
            <tr style="height: 18px;">
                <td style="width: 98.9774%; height: 18px;" colspan="4"><strong>SAMPAI DENGAN BULAN <?= strtoupper(Yii::$app->formatter->asDate($model->tmtberhenti, 'MMMM yyyy')) ?> TELAH DIBAYARKAN GAJI DENGAN RINCIAN :</strong></td>
            </tr>
            <tr style="height: 18px;">
                                ...
                                <td style="width: 49%; vertical-align:text-top;">
                                    <table style="border-collapse: collapse; width: 100%; height: 54px;" border="1">
                                        <tbody>
                                            ...
                                            <?php
                                            $jumlahpenghasilan = 0;
                                            foreach ($modelskppgaji as $value1) :
                                ...
                                <td style="width: 49%; vertical-align:text-top;">
                                    <table style="border-collapse: collapse; width: 100%;" border="1">
                                        <tbody>
                                            ...
                                            <?php
                                            $jumlahpotongan = 0;
                                            foreach ($modelskppgaji as $value2) :
                                ...
                                <td style="width: 100%;">
                                    <table style="border-collapse: collapse; width: 100%; height: 35px;" border="1">
                                        <tbody>
                                            ...
                                            <?php
                                            foreach ($modelskppbayarlain as $value3) :
                                            ?>
                                                <tr style="height: 18px;">
                                ...
                                <td style="width: 100%;">
                                    <table style="border-collapse: collapse; width: 100%; height: 54px;" border="1">
                                        <tbody>
                                            ...
                                            <?php
                                            foreach ($modelskpputang as $value4) :
                                            ?>
                                                <tr style="height: 18px;">

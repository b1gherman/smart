        ...
        <tbody>
            <tr>
                <td rowspan="1" colspan="4"> Bersama ini kami sampaikan berkas usulan
                    kenaikan pangkat untuk Pegawai Negeri Sipil :</td>
            </tr>
            <tr>
            ...
            <tr>
                <td rowspan="1" colspan="4">Kami usulkan pangkatnya untuk dinaikkan
                    lebih tinggi menjadi <?= $model->golongan->pangkat . ' / ' . $model->golongan->kode_gol ?>. Sebagai kelengkapan

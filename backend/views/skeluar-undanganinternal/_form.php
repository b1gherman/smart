    ...
    if ($role == 'admin') {?>      
        ...
        <div class="row">
            ...
            if (!empty($model->file_upload)) {
                ...
                $json[] = [
                    'caption' => $model->file_upload, yii\helpers\Url::to(['/skeluar-undanganinternal/delete-upload']),
            ...
            <?php if (!$model->isNewRecord) : ?>
                ...
                $form->field($model, 'file_upload')->widget(kartik\file\FileInput::className(), [
                    ...
                    'pluginOptions' => [
                        ...
                        'deleteUrl' => yii\helpers\Url::to(['/skeluar-undanganinternal/delete-upload']),

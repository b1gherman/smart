...
<div class="skeluar-undanganeksternal-form">
    ...
    if ($role == 'admin') {?>      
        ...
        <div class="row">
            ...
            if (!empty($model->file_upload)) {
                ...
                $json[] = [
                    'caption' => $model->file_upload, yii\helpers\Url::to(['/skeluar-undanganeksternal/delete-upload']),
                    'key' => 'file_upload' . $model->id,
                    //'url' => yii\helpers\Url::to(['skeluar-undanganeksternal/delete-upload'])
                ];
            }
            ?>
            <?php if (!$model->isNewRecord) : ?>
                ...
                $form->field($model, 'file_upload')->widget(kartik\file\FileInput::className(), [
                    ...
                    'pluginOptions' => [
                        ...
                        'deleteUrl' => yii\helpers\Url::to(['/skeluar-undanganeksternal/delete-upload']),

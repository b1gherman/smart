...
use Yii;
use backend\models\SkeluarSuratdinas;
use backend\models\SkeluarSuratdinasSearch;
...
/**
 * SkeluarSuratdinasController implements the CRUD actions for SkeluarSuratdinas model.
 */
class SkeluarSuratdinasController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * Lists all SkeluarSuratdinas models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new SkeluarSuratdinasSearch();
    ...
    /**
     * Displays a single SkeluarSuratdinas model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Creates a new SkeluarSuratdinas model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new SkeluarSuratdinas();
    ...
    /**
     * Updates an existing SkeluarSuratdinas model.
    ...
    /**
     * Deletes an existing SkeluarSuratdinas model.
    ...
    /**
     * Finds the SkeluarSuratdinas model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return SkeluarSuratdinas the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = SkeluarSuratdinas::findOne($id)) !== null) {
            return $model;
        }
    ...
    public function actionDeleteUpload() {
        ...
        $model = SkeluarSuratdinas::find()->where([
                    'id' => $key[1],
    ...
    public function actionReport($id) {
        ...
        $content = $this->renderPartial('_reportSuratdinas', [
            'model' => $model,

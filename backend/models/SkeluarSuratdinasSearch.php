...
/**
 * SkeluarSuratdinasSearch represents the model behind the search form of `backend\models\SkeluarSuratdinas`.
 */
class SkeluarSuratdinasSearch extends SkeluarSuratdinas
{
    /**
     * {@inheritdoc}
     */

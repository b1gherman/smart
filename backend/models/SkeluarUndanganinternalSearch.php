...
/**
 * SkeluarUndanganinternalSearch represents the model behind the search form of `backend\models\SkeluarUndanganinternal`.
 */
class SkeluarUndanganinternalSearch extends SkeluarUndanganinternal
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = SkeluarUndanganinternal::find();
